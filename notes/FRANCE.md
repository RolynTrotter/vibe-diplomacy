...
clear long-term threat; keep an eye on the east but don't let it distract from a
clean 2-build year (Spain + Portugal).

## Diplomacy round 1
- ENGLAND: proposed firm DMZ on the Channel (ENG). I stay out, they stay out.
  Floated future Atlantic partnership + possible support toward Belgium vs a
  greedy Germany. Goal: neutralize the north so I can build freely.
- GERMANY: proposed quiet Burgundy, conceded Belgium to them, framed England as
  the shared concern. Hedge against England — I'm courting both, will commit to
