...
## Standing plan
- Dominate eastern Med and Balkans; aim for 6+ SC by 1903.
- Priority targets: GRE, RUM, then AEG/EAS control.

## End of 1901 position (W1901A)
- Units: A BUL, A CON, F BLA, + built F SMY = 4 units
- Centers: ANK, CON, SMY, BUL (4 SC)
- GRE bounced — Austria beat us in from ALB (Austria supported in).
- BLA captured — F ANK→BLA succeeded vs Russia F SEV.
- Built: F SMY (fleet for AEG/EAS pressure)
...
### F1901M
- A BUL - GRE (bounced — Austria won GRE)
- A CON - BUL (back-fill succeeded)
- F ANK - BLA (succeeded — BLA taken)
### W1901A
- Built F SMY

## Trust / read on opponents
- RUSSIA: Lost BLA — F SEV was defending it but failed. Expect Russian pressure to retake BLA; watch for F SEV - BLA next spring.
