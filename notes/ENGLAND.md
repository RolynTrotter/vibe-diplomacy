...
## Standing plan
- Secure home centers (EDI, LON, LVP)
- Alliance with France (Channel DMZ holds)
- Expand into Low Countries and Scandinavia
...
- W1901A: Built F LVP
- S1902M: F SKA→NWY, F BEL→HOL (bounced), A LON→YOR, F LVP→IRI
- F1902M: F NWY bounced, F BEL bounced, F IRI→MAO succeeded
- W1902A: Built F LVP (now 5 units at 5 centers)
- S1903M: F BEL→HOL (bounced), F NWY→SWE (bounced), A YOR→LON, F WAL→IRI, F NAO→MAO
